...
class Foo {
  ...
  final val strategy = new FunctionLifter[Map[String, String], ImplicitArgumentExtractors[Map[String, String]], DirectInvocation](new ImplicitArgumentExtractors[Map[String, String]], new DirectInvocation)
